          ...
          <div className="flex items-center justify-between gap-1">
            {items.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <motion.span
                    className={`relative mt-0.5 text-[9px] font-medium ${isActive ? 'text-blue-300' : ''}`}
                    initial={{ opacity: 0.6 }}
            ...
            <div className="relative">
              <button
                ...
                className="flex flex-col items-center justify-center w-11 h-11 rounded-xl text-white/50 hover:bg-white/5 hover:text-white/80 transition-all duration-200"
                title="Language"
              >
