...
const SCREEN_GROUPS: ScreenGroup[] = [
  {
    ...
    screens: [
      ...
      { src: "/images/mento/04-sign-up-1.png", label: "Sign Up" },
      { src: "/images/mento/05-sign-up-2.png", label: "Sign Up (alt)" },
    ],
  },
  {
    ...
    screens: [
      { src: "/images/mento/06-otp.png", label: "OTP Input" },
      { src: "/images/mento/07-otp-success.png", label: "OTP Success" },
      { src: "/images/mento/08-otp-error.png", label: "OTP Error" },
    ],
  },
  {
    ...
    screens: [
      { src: "/images/mento/09-forgot-password-initial.png", label: "Initial" },
      { src: "/images/mento/10-forgot-password-activated.png", label: "Activated" },
      { src: "/images/mento/11-forgot-password-error.png", label: "Error" },
    ],
  },
  {
    title: "New Password",
    ...
    screens: [
      { src: "/images/mento/12-new-password-initial.png", label: "Initial" },
      { src: "/images/mento/13-new-password-checked.png", label: "Validated" },
      { src: "/images/mento/14-new-password-checked-2.png", label: "Validated (alt)" },
      { src: "/images/mento/15-new-password-error.png", label: "Error" },
    ],
  },
];
